...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widgetDisplay.setGeometry(QtCore.QRect(10, 60, 511, 441))
        self.widgetDisplay.setObjectName("widgetDisplay")
        self.groupInit = QtWidgets.QGroupBox(self.centralWidget)
        self.groupInit.setGeometry(QtCore.QRect(530, 20, 211, 140))
        ...
        # 新增「載入模型」按鈕
        self.bnLoadModel = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.bnLoadModel.setObjectName("bnLoadModel")
        self.gridLayout.addWidget(self.bnLoadModel, 3, 1, 1, 2)

        self.groupGrab = QtWidgets.QGroupBox(self.centralWidget)
        self.groupGrab.setEnabled(False)
        self.groupGrab.setGeometry(QtCore.QRect(530, 170, 211, 171))
        ...
        self.groupParam.setGeometry(QtCore.QRect(530, 350, 211, 151))
